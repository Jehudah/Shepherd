...
export default function StudyThemes() {
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-3xl p-6 sm:p-8 shadow-xl">
        <div className="flex items-center space-x-4">
          <BookMarked size={48} />
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold">Themes</h1>
            <p className="text-lg sm:text-xl opacity-90 mt-2">
              Deep theological study of biblical themes with cross-references
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              These articles explore major biblical themes in depth, tracing them throughout Scripture and showing how they connect to God's overall plan of redemption.
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                  <BookOpen size={24} />
                </div>
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 border-amber-200 dark:border-amber-800">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              We're working on adding more theological theme studies covering topics like Hope, Peace, Wisdom, Redemption, and many more. Check back regularly!
            </p>
          </div>
        </div>
      </div>
