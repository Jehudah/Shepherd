...
const lessons = [
  { id: 'parables-kingdom-1', title: 'Kingdom Parables: Foundations', difficulty: 1, questions: 12 },
  { id: 'parables-kingdom-2', title: 'Readiness & Faithfulness', difficulty: 2, questions: 12 },
  { id: 'parables-kingdom-3', title: 'Grace & Obedience', difficulty: 3, questions: 12 },
  { id: 'parables-kingdom-4', title: 'Judgment & Mercy', difficulty: 4, questions: 12 },
  { id: 'parables-kingdom-5', title: 'Lost & Found', difficulty: 5, questions: 12 }
];
...
export default function Parables() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white rounded-3xl p-6 sm:p-8 shadow-xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold">Parables & Stories</h1>
            ...
            >
              ...
              {canAccess ? (
                <div className="space-y-2">
                  <Link
                    to={`/lesson/parables/kingdom/${lesson.id}`}
                    className={`w-full ${
                      isCompleted
