...
const lessons = [
  { id: 'verses-salvation-1', title: 'Salvation: Core Verses', difficulty: 1, questions: 12 },
  { id: 'verses-salvation-2', title: 'Salvation: Deeper Study', difficulty: 2, questions: 12 },
  { id: 'verses-salvation-3', title: 'Assurance & Peace', difficulty: 3, questions: 12 },
  { id: 'verses-salvation-4', title: 'Living by Faith', difficulty: 4, questions: 12 },
  { id: 'verses-salvation-5', title: 'Master Challenge', difficulty: 5, questions: 12 }
];

export default function MemorizeVerses() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-r from-yellow-500 to-amber-500 text-white rounded-3xl p-6 sm:p-8 shadow-xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold">Memorize Verses</h1>
            ...
            >
              ...
              {canAccess ? (
                <div className="space-y-2">
                  <Link
                    to={`/lesson/verses/salvation/${lesson.id}`}
                    className={`w-full ${
                      isCompleted
