 ...
 *
 * INSTRUCTIONS:
 * 1. Copy this file to `firebase-config.ts` in the same directory
 * 2. Update the firebaseConfig object with values from .env
 * 3. NEVER commit firebase-config.ts to git!
 *
 * Or better yet, this file is already configured to read from .env
 * So you just need to update the .env file!
 */
