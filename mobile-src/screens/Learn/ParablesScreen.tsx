...
const parableLessons: ParableLesson[] = [
  {
    ...
    description: 'Seeds, treasure, and the nature of God\'s kingdom',
    parables: ['The Sower', 'Mustard Seed', 'Weeds', 'Hidden Treasure', 'Pearl', 'The Net'],
    questionCount: 12,
    xpReward: 120,
  },
  {
    ...
    title: 'Wise & Ready',
    description: 'Be prepared for the coming of the Lord',
    parables: ['The Yeast', 'Wedding Banquet', 'Ten Virgins', 'The Talents'],
    questionCount: 12,
    xpReward: 120,
  },
  {
    ...
    description: 'Using what God entrusts to you',
    parables: ['Workers in the Vineyard', 'The Two Sons', "God's Grace"],
    questionCount: 12,
    xpReward: 120,
  },
  {
    id: 'parables-kingdom-4',
    title: "God's Patience & Forgiveness",
    description: 'Judgment, mercy, and the call to forgive',
    parables: ['The Tenants', 'The Fig Tree', 'Unmerciful Servant'],
    questionCount: 12,
    xpReward: 120,
  },
  {
    ...
    title: 'Lost & Found',
    description: "God's great joy over every soul that returns",
