...
export const creationQuestions: Record<string, Question[]> = {
  'timeline-creation-1': [
    ...
    },
    {
      ...
      options: ['God placed Adam in the garden', 'Eve was created from Adam\'s rib', 'The serpent tempted Eve', 'Adam and Eve ate the forbidden fruit'],
    ...
    },
    {
      ...
      options: ['God accepted Abel\'s offering but rejected Cain\'s', 'Adam and Eve had more children', 'Cain built a city', 'Enoch was born'],
    ...
    },
    {
      ...
      options: ['God marked Cain and sent him away', 'Seth was born', 'The flood came', 'Abraham was called'],
    ...
    },
    {
      ...
      options: ['Methuselah (969 years)', 'Noah (950 years)', 'Adam (930 years)', 'Seth (912 years)'],
    ...
    },
    {
      ...
      options: ['Creation of light', 'Creation of humans', 'The Fall', 'Cain and Abel\'s offerings'],
    ...
    },
    {
      ...
      options: ['7th from Adam', '5th from Adam', '10th from Adam', '3rd from Adam'],
    ...
    },
    {
      ...
      options: ['Enosh (Seth\'s son)', 'Abel', 'Cain', 'Enoch'],
    ...
    },
    {
      ...
      options: ['10 generations', '7 generations', '12 generations', '40 generations'],
  ...
  'timeline-creation-2': [
    ...
    },
    {
      ...
      options: ['120 years', '40 years', '100 years', '7 years'],
    ...
    },
    {
      ...
      options: ['40 days and 40 nights', '150 days', '1 year', '7 days'],
    ...
    },
    {
      ...
      options: ['Built an altar and offered sacrifices', 'Planted a vineyard', 'Had more children', 'Sent out the animals'],
    ...
    },
    {
      ...
      options: ['The rainbow', 'A dove', 'A mountain', 'The ark itself'],
    ...
    },
    {
      ...
      options: ['About 1 year (370 days)', '40 days', '150 days', '300 days'],
    ...
    },
    {
      ...
      options: ['Ham', 'Shem', 'Japheth', 'None were cursed'],
      correctAnswer: 'Ham'
    },
    {
      ...
      options: ['600 years old', '500 years old', '950 years old', '120 years old'],
    ...
    },
    {
      ...
      options: ['Shem', 'Ham', 'Japheth', 'None - Abraham came before Noah'],
      correctAnswer: 'Shem'
    }
  ],
  ...
  'timeline-creation-3': [
    ...
    },
    {
      ...
      options: ['75 years old', '50 years old', '100 years old', '40 years old'],
    ...
    },
    {
      ...
      options: ['100 years old', '75 years old', '99 years old', '86 years old'],
    ...
    },
    {
      ...
      options: ['Ishmael (to Hagar)', 'Isaac (to Sarah)', 'Esau (to Rebekah)', 'Jacob (to Rebekah)'],
    ...
    },
    {
      ...
      options: ['Three visitors came to Abraham', 'Lot escaped to Zoar', 'Lot\'s wife became a pillar of salt', 'Isaac was born'],
    ...
    },
    {
      ...
      options: ['After Isaac had grown to be a young man', 'Right after Isaac was born', 'Before Isaac was born', 'After Sarah died'],
